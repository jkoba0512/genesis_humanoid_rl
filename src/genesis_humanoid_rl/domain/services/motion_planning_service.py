...
class MotionPlanningService:
    ...
    def create_motion_command(self, 
                            target_skill: SkillType, 
                            context: Optional[TrainingContext] = None) -> MotionCommand:
        """
    ...
    def _calculate_velocity(self, skill_config: Dict, context: TrainingContext) -> float:
        ...
        if context.environment_constraints and 'max_velocity' in context.environment_constraints:
