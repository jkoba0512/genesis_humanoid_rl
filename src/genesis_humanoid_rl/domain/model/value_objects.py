...
class SkillAssessment:
    ...
    def is_reliable_assessment(self, min_confidence: float = 0.7, 
                             min_evidence: float = 0.6) -> bool:
        """Check if assessment is reliable."""
        return (self.confidence_level >= min_confidence and 
                self.evidence_quality >= min_evidence)
