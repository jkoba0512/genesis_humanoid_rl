...
from .humanoid_env_v2 import HumanoidWalkingEnvV2, EnvironmentConfig, make_humanoid_env_v2
...
class LegacyHumanoidWalkingEnv(Env):
    ...
    def scene(self):
        ...
        warnings.warn(
            "Direct scene access is deprecated. Use the new API.",
            DeprecationWarning
        )
    ...
    def robot(self):
        ...
        warnings.warn(
            "Direct robot access is deprecated. Use the new API.",
            DeprecationWarning
        )
    ...
    def _get_observation(self) -> np.ndarray:
        ...
        if hasattr(self._env, 'robot_state') and self._env.robot_state is not None:
            ...
            return self._env.observations.get_observation(self._env.robot_state, context)
