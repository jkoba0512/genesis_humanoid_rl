...
async def get_system_status():
    ...
    try:
        ...
        elif system_resources['memory_percent'] > 90 or system_resources['disk_percent'] > 90:
            system_status = "degraded"
        else:
    ...
    try:
        system_info = {
            ...
            "features": {
                ...
                "multi_robot": True,
                "gpu_acceleration": check_genesis_status().get('features', {}).get('gpu_acceleration', False),
...
async def cleanup_system(
    ...
    older_than_days: int = Query(7, ge=1, description="Clean up files older than N days")
):
    """
