...
class TensorAdapter:
    ...
    def to_tensor(self, value: DomainNumericValue) -> TensorType:
        ...
        try:
            ...
            if isinstance(value, (int, float)):
                return self._torch.tensor(value, dtype=self._torch.float32, device=self.device)
    ...
    def clip(self, value: DomainNumericValue, min_val: float, max_val: float) -> DomainNumericValue:
        """
...
def safe_clip(value: DomainNumericValue, min_val: float, max_val: float) -> DomainNumericValue:
    """Safe clip operation."""
