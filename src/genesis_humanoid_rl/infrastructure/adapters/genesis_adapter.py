...
from ...domain.model.value_objects import MotionCommand, MotionType, GaitPattern, MovementTrajectory
...
class GenesisSimulationAdapter:
    ...
    def execute_motion_command(self, robot: HumanoidRobot, 
                             command: MotionCommand) -> Dict[str, Any]:
        """
    ...
    def _convert_trajectory_to_genesis(self, trajectory: MovementTrajectory) -> Dict[str, Any]:
