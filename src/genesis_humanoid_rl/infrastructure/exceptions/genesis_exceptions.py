...
class GenesisExceptionMapper:
    ...
    def map_exception(
        ...
        if error_type in [GenesisErrorType.PHYSICS_INSTABILITY, GenesisErrorType.SOLVER_FAILURE]:
            severity = "high"
            retryable = True
        elif error_type in [GenesisErrorType.MEMORY_EXHAUSTION, GenesisErrorType.GPU_ERROR]:
            severity = "high"
            retryable = True
        ...
        elif error_type in [GenesisErrorType.ROBOT_LOADING, GenesisErrorType.URDF_PARSING]:
            exception_class = GenesisRobotError
        elif error_type in [GenesisErrorType.SCENE_CREATION, GenesisErrorType.ENTITY_ADDITION]:
