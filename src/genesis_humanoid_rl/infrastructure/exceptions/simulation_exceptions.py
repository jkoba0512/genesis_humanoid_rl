...
class RobotControlError(SimulationError):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            message,
            recovery_action="Validate and clip action commands",
            **kwargs
        )
        self.action = action
...
class TrainingError(SimulationError):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            message,
            recovery_action="Adjust training parameters and restart",
            **kwargs
        )
...
class SimulationErrorHandler:
    ...
    def handle_error(
        self,
        error: Exception,
        context: Optional[SimulationErrorContext] = None
    ) -> Dict[str, Any]:
        """
    ...
    def _handle_physics_instability(
        self,
        error: PhysicsInstabilityError,
        context: Optional[SimulationErrorContext]
    ) -> Dict[str, Any]:
    ...
    def _handle_genesis_error(
        ...
        return {
            ...
            'retry_count': self.recovery_attempts.get(f'genesis_{error.error_type.value}', 0) + 1
        }
