...
def main():
    ...
    parser.add_argument("--output", default="genesis_robot_video.mp4",
    ...
    parser.add_argument("--orbit", action="store_true",
                       help="Orbit camera around robot")
    ...
    def get_observation():
        ...
        return np.concatenate([pos, quat, joint_pos, joint_vel, prev_action, target_vel])
