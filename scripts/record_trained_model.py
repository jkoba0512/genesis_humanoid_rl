...
def main():
    ...
    parser.add_argument("--output", default="trained_humanoid_demo.mp4",
    ...
    if args.episodes > 1:
        ...
        merge_cmd = f"ffmpeg -f concat -safe 0 -i {concat_file} -c copy {args.output} -y"
        os.system(merge_cmd)
    ...
    for info in episode_info:
        print(f"Episode {info['episode']}: {info['steps']} steps, "
