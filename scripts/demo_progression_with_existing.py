...
def create_learning_curve_animation():
    ...
    discovering = 20 * (1 - np.exp(-steps/30000)) + np.random.normal(0, 8, len(steps)) - 20
    smooth_walking = 80 * (1 - np.exp(-steps/40000)) + np.random.normal(0, 5, len(steps)) - 10
    ...
    ax1.text(5000, -80, 'Untrained\n(Falls)', ha='center', va='center', 
             bbox=dict(boxstyle="round,pad=0.3", facecolor="red", alpha=0.3))
    ax1.text(25000, -30, 'Early Learning\n(Balance)', ha='center', va='center',
             bbox=dict(boxstyle="round,pad=0.3", facecolor="orange", alpha=0.3))
    ax1.text(50000, 20, 'Discovering\n(First Steps)', ha='center', va='center',
             bbox=dict(boxstyle="round,pad=0.3", facecolor="yellow", alpha=0.3))
    ax1.text(80000, 60, 'Smooth Walking\n(Mastery)', ha='center', va='center',
    ...
    def init():
        line.set_data([], [])
        point.set_data([], [])
        return line, point, robot_body, robot_head, robot_leg1, robot_leg2, progress_text
    ...
    anim.save(os.path.join(output_dir, 'learning_progression_animation.gif'), 
