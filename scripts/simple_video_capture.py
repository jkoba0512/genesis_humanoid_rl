...
def main():
    parser = argparse.ArgumentParser(description="Simple video capture of trained model")
    parser.add_argument("--model", default="./models/test_sb3/final_model",
                       help="Path to trained model")
    parser.add_argument("--output", default="humanoid_animation.mp4",
    ...
    def animate(frame):
        ...
        ax1.plot(positions[:frame, 0], positions[:frame, 1], positions[:frame, 2], 'b-', alpha=0.7)
        ax1.scatter(positions[frame-1, 0], positions[frame-1, 1], positions[frame-1, 2], 
